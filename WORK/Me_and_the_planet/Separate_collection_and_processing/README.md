...
| Переработка                  | Q132580     | процесс преобразования отходов во вторичное сырье     |
...
| Знак переработки             | Q219534     | маркировка, указывающая на возможность переработки    |
| Пластик                      | Q11474      | синтетический материал, широко используемый в упаковке|
| Бумага                       | Q11472      | материал, пригодный для переработки                   |
| Стекло                       | Q11469      | материал, пригодный для многократной переработки      |
| Металл                       | Q11426      | материал, который может использоваться повторно       |
| Батарейка                    | Q267298     | источник питания, требующий специальной утилизации    |
