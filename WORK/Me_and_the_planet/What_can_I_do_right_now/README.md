...
#### Пример запроса для получения связей между экологическими сущностями:
...
Результат выполнения запроса был сохранён в файле:  
`WORK/eco_actions/wikidata_export.json`
